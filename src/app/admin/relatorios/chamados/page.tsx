...
/* =========================================================
   ...
   ETAPA 54.2 — RELATÓRIOS GERENCIAIS / CHAMADOS

   Atualização:
   - Página reaproveitada como relatório específico de chamados.
   - Nova rota prevista: /admin/relatorios/chamados.
   - Mantido current="relatorios" no AdminShell.
   - Ajustados textos para compor a central de Relatórios Gerenciais.
   - Incluído atalho de retorno para /admin/relatorios.
...
/* =========================================================
   PÁGINA DE RELATÓRIOS DE CHAMADOS
   ========================================================= */

export default function RelatoriosChamadosPage() {
  ...
  return (
    <AdminContextGuard
      ...
      fallbackDescription="Os relatórios administrativos de chamados são exclusivos para a administradora. Para acompanhar chamados como síndico, morador, proprietário ou conselheiro, acesse o portal."
    >
      <AdminShell
        current="relatorios"
